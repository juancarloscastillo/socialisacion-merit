...
```
Este documento presenta información adicional para conocer con mayor detalle el proyecto de investigación. En general se ha seguido la plantilla de preinscripción de AsPredicted.org, añadiendo adicionalmente un abstract proyecto y una descripción de las variables independientes.
