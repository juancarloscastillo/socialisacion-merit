...
### Tablas y gráficos bivariados de variables principales

```{r}
## Variables numericas x genero estudiante
...
### Modelos de regresión clmm (esfuerzo)
```{r Modelos Indicadores por separado: Esfuerzo, eval=FALSE, include=FALSE, results='asis'}
# Regresiones simples
...
### Modelos de regresión clmm (trabajo duro)
```{r Modelos Indicadores por separado: Trabajo duro, eval=FALSE, include=FALSE, results='asis'}
# Regresiones simples
