...
### Tabla de descriptivos univariados: todas las variables
...
### Gráfico de barras: percepción trabajo duro esutudiantes y apoderados
...
### Gráfico de barras: Percepción esfuerzo esutudiantes y apoderados
...
### Tabla de descriptivos univariados: sentido de justicia indirecto (logaritmico y no logaritmico) 
```{r}
...
### Gráfico de densidad: Sentido de justicia indirecto
```{r}
# Density plot 
...
### Tabla de frecuencias: sentido de justicia directo

```{r}
frq(ap_est$sj_direct_factor)
```
...
### Tabla descriptivos bivariados: variables númericas x genero estudiante
...
### Tabla descriptivos bivariados: variables númericas x posición política estudiantes
...
### Tabla descriptivos bivariados: variables númericas x quintiles de ingresos
...
### Tabla descriptivos bivariados: variables númericas x sentido de justicia directo
...
### Tabla descriptivos bivariados: variables númericas x respuesta del profesor
...
### Tabla de contingencia: sentido de justicia directo x genero estudiantes 
...
### Tabla de contingencia: sentido de justicia directo x posición política estudiantes 
...
```
### Tabla de contingencia: sentido de justicia directo x quintiles de ingreso
...
```
### Tabla de contingencia: sentido de justicia directo x dependencia administrativa
...
### Tabla de contingencia: Percepcion esfuerzo estudiante x genero estudiante
...
### Tabla de contingencia: percepcion esfuerzo estudiante x posición política estudiantes
...
### Tabla de contingencia: percepción esfuerzo estudiante x quintiles de ingreso
...
### Tabla de contingencia: percepción esfuerzo estudiante x dependencia administrativa
...
### Tabla de contingencia: percepción esfuerzo estudiante x percepción esfuerzo apoderados
...
### Tabla de contingencia: percepción esfuerzo estudiante x percepción trabajo duro apoderados
...
#### Tabla de contingencia: percepcion trabajo duro estudiante x genero estudiante
...
### Tabla de contingencia: percepcion trabajo duro estudiante x posición política estudiante
...
### Tabla de contingencia: percepcion trabajo duro estudiante x quintiles de ingreso
...
### Tabla de contingencia: Percepcion trabajo duro estudiante x dependencia administrativa
...
### Tabla de contingencia: percepcion trabajo duro estudiante x percepción trabajo duro apoderados
...
### Tabla de contingencia: percepcion trabajo duro estudiante x percepción esfuerzo apoderados
...
### Tabla de contingencia: recompensa justa estudiantes x genero estudiante
...
### Tabla de contingencia: recompensa justa estudiantes x posición política estudiantes
...
### Tabla de contingencia: recompensa justa estudiantes x quintiles de ingresos
...
### Tabla de contingencia: recompensa justa estudiantes x dependencia administrativa
...
```{r}
# Perc. Esfuerzo. Est x Resp prof
polychor(ap_est$perc_esfuerzo_factor_est, ap_est$resp_prof_factor, std.err = TRUE)

# Perc. Esfuerzo. Est x Quintiles ingresos
polychor(ap_est$perc_esfuerzo_factor_est, ap_est$quintiles_ingresos_pc_factor, std.err = TRUE)

# Perc. Esfuerzo. Est x Recompensa apoderado
polychor(ap_est$perc_esfuerzo_factor_est, ap_est$recompensa_factor_ap, std.err = TRUE)

# Perc. Esfuerzo. Est x Recompensa estudiante
polychor(ap_est$perc_esfuerzo_factor_est, ap_est$recompensa_factor_est, std.err = TRUE)

# Perc. Esfuerzo. Est x Sentido de justucia directo
polychor(ap_est$perc_esfuerzo_factor_est, ap_est$sj_direct_factor, std.err = TRUE)

# Perc. Esfuerzo. Est x Perc. Esfuerzo. Ap
polychor(ap_est$perc_esfuerzo_factor_est, ap_est$perc_esfuerzo_factor_ap, std.err = TRUE)

# Perc. Esfuerzo. Est x Perc. Trabajo Duro Ap
polychor(ap_est$perc_esfuerzo_factor_est, ap_est$perc_trabajo_duro_factor_ap, std.err = TRUE)

#---------------------------------------------------------------------------------------------

# Perc. Trabajo Duro. Est x Resp prof
polychor(ap_est$perc_trabajo_duro_factor_est, ap_est$resp_prof_factor, std.err = TRUE)

# Perc. Trabajo Duro. Est x Quintiles ingresos
polychor(ap_est$perc_trabajo_duro_factor_est, ap_est$quintiles_ingresos_pc_factor, std.err = TRUE)

# Perc. Trabajo Duro. Est x Recompensa apoderado
polychor(ap_est$perc_trabajo_duro_factor_est, ap_est$recompensa_factor_ap, std.err = TRUE)

# Perc. Trabajo Duro. Est x Recompensa estudiante
polychor(ap_est$perc_trabajo_duro_factor_est, ap_est$recompensa_factor_est, std.err = TRUE)

# Perc. Trabajo Duro. Est x Sentido de justicia directo
polychor(ap_est$perc_trabajo_duro_factor_est, ap_est$sj_direct_factor, std.err = TRUE)

# Perc. Trabajo Duro Est x Perc. Esfuerzo. Ap
polychor(ap_est$perc_trabajo_duro_factor_est, ap_est$perc_esfuerzo_factor_ap, std.err = TRUE)

# Perc. Trabajo Duro Est x Perc. Trabajo Duro AP
polychor(ap_est$perc_trabajo_duro_factor_est, ap_est$perc_trabajo_duro_factor_ap, std.err = TRUE)
```
...
### Modelos de regresión lmer: reg. simples con n diferido
...
### Modelos de regresión clmm (esfuerzo): reg. simple con n diferido
...
### Modelos de regresión clmm (esfuerzo): reg. multiple con n homogeneo
...
### Modelos de regresión clmm (trabajo duro): reg. simple con n diferido
...
### Modelos de regresión clmm (trabajo duro): reg. multiple con n homogeneo
...
### ### Modelos de regresión clmm (trabajo duro): versión minimalista
...
### Matriz de correlación con variables de interés post-modelos
