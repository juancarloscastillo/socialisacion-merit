...
```{r}
select(ap_est, sj_indirect_ln, sj_indirect_noln) %>% summarytools::descr() %>% kable( format = "markdown",digits = 2,col.names = c("Sentido de justicia en las notas (Log)","Sentido de justicia en las notas (no Log)"), caption = "Factor loadings")
```
...
## Parte 3: Análisis descriptivo bivariado {.tabset}
