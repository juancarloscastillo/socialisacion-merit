...
```{r}
est_proc$perc_trabajo_duro <- set_label(x = est_proc$perc_trabajo_duro,label = "Percepción meritocracia: Importancia trabajo duro estudiantes") # Etiquetar
```
...
save(ap_est, file = "../input/data/ap_est.RData",ascii = T)    # Guardar base de datos conjunta
