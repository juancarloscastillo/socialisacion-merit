...
#### Sentirse escuchado por profesor. 

```{r}
 freq(est_proc$resp_porf)
```
...
est_proc$resp_porf <- set_na(est_proc$resp_porf, na = c(5,9), drop.levels = TRUE, as.tag = FALSE)
est_proc$genero_factor <- set_label(x = est_proc$resp_porf, label = "Siento que mi opinión es tomada en cuenta por mis profesores")
