...
# Etiquetar
est_proc$sj_direct_factor <- set_label(x = est_proc$sj_direct_factor, label = "Sentido de Justicia directo")
```
...
ap_est$educ_factor_ap <- set_label(x = ap_est$educ_factor_ap,label = "Nivel educacional de los apoderados") # Etiquetar
```
