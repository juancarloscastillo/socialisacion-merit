...
geometry: paperheight= 11in, paperwidth=11in, margin=0.75in # márgenes de página
header-includes:
...
knitr::kable(collapse_rows_dt, format =table_format, caption = "Resumen Modelos de Mediación Percepciones Meritocráticas Estudiantes", align = "c",col.names = c("Mediador (Centrada)","Independiente", "Efectos Directos", "Efectos Indirectos", "Efectos Totales", "% de Efectos Indirectos")) %>% 
   kable_styling(full_width = F,latex_options = c("scale_down","HOLD_position")) %>%
