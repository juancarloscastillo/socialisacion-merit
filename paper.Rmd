...
ref <- "(1|rbd_est)"
cap <- "Modelos ordinal logit multinivel para Socialización de importancia del trabajo duro"
...
kbl(collapse_rows_dt, format =table_format, caption = "Resumen Modelos de Mediación Percepciones Meritocráticas Estudiantes", align = "c",col.names = c("Mediador (Centrada)","Independiente", "Efectos Directos", "Efectos Indirectos", "Efectos Totales", "% de Efectos Indirectos")) %>% 
