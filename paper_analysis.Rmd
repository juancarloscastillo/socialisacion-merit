...
### Promedio: trabajo duro + recompensa 
```{r,results='asis'}
...
* Dummy estudiante y apoderado: 'Es importante' (1; Importante + Muy importante = 3+4) vs 'No es importante' (0; Nada importante + Algo importante = 1+2)"
```{r,results='asis'}
getah.log1 <- glmer(formula(paste("perc_tduro_bi2_est~",paste(c("perc_tduro_bi2_ap",ref),collapse="+"))), basereg,family = "binomial")
getah.log2 <- glmer(formula(paste("perc_tduro_bi2_est~",paste(c("sj_indirect_noln",ref),collapse="+"))), basereg,family = "binomial")
getah.log3 <- glmer(formula(paste("perc_tduro_bi2_est~",paste(c("sj_direct_factor",ref),collapse="+"))), basereg,family = "binomial")
getah.log4 <- glmer(formula(paste("perc_tduro_bi2_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor",ref),collapse="+"))), basereg,family = "binomial")
getah.log5 <- glmer(formula(paste("perc_tduro_bi2_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor",con,ref),collapse="+"))), basereg,family = "binomial")
getah.log6 <- glmer(formula(paste("perc_tduro_bi2_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi2_ap*sj_indirect_noln",ref),collapse="+"))), basereg,family = "binomial")
getah.log7 <- glmer(formula(paste("perc_tduro_bi2_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi2_ap*sj_direct_factor",ref),collapse="+"))), basereg,family = "binomial")
getah.log8 <- glmer(formula(paste("perc_tduro_bi2_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi2_ap*sj_direct_factor","univ_esc",ref),collapse="+"))), basereg,family = "binomial")
...
knitreg(list(getah.log1,getah.log2,getah.log3,getah.log4,getah.log5,getah.log6,getah.log7,getah.log8),
        ...
        #             "Sentido justicia (directo)"=7:8),
        custom.coef.names=coef_names,
        custom.note="*** p < 0.001; ** p < 0.01; * p < 0.05; ¹Estudiantes y Apoderados: 'Es importante' (Importante + Muy importante) y 'No es importante' (Nada importante + Algo Importante)"        
        )
```

* Dummy estudiante y apoderado: 'Es importante' (1; Muy importante = 4) vs 'No es importante' (0; Nada importante + Algo importante +Importante = 1+2+3)"

```{r,results='asis'}
getah.log1 <- glmer(formula(paste("perc_tduro_bi3_est~",paste(c("perc_tduro_bi3_ap",ref),collapse="+"))), basereg,family = "binomial")
getah.log2 <- glmer(formula(paste("perc_tduro_bi3_est~",paste(c("sj_indirect_noln",ref),collapse="+"))), basereg,family = "binomial")
getah.log3 <- glmer(formula(paste("perc_tduro_bi3_est~",paste(c("sj_direct_factor",ref),collapse="+"))), basereg,family = "binomial")
getah.log4 <- glmer(formula(paste("perc_tduro_bi3_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor",ref),collapse="+"))), basereg,family = "binomial")
getah.log5 <- glmer(formula(paste("perc_tduro_bi3_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor",con,ref),collapse="+"))), basereg,family = "binomial")
getah.log6 <- glmer(formula(paste("perc_tduro_bi3_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi3_ap*sj_indirect_noln",ref),collapse="+"))), basereg,family = "binomial")
getah.log7 <- glmer(formula(paste("perc_tduro_bi3_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi3_ap*sj_direct_factor",ref),collapse="+"))), basereg,family = "binomial")
getah.log8 <- glmer(formula(paste("perc_tduro_bi3_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi3_ap*sj_direct_factor","univ_esc",ref),collapse="+"))), basereg,family = "binomial")
...
knitreg(list(getah.log1,getah.log2,getah.log3,getah.log4,getah.log5,getah.log6,getah.log7,getah.log8),
        ...
        #             "Sentido justicia (directo)"=7:8),
        custom.coef.names=coef_names,
        custom.note="*** p < 0.001; ** p < 0.01; * p < 0.05; ¹Estudiantes y Apoderados: 'Es importante' (Muy importante) y 'No es importante' (Nada importante + Algo Importante+Importante)"        
        )
```
...
#### Alternativa dummy apoderado

* Dummy de apoderado: 'Es importante' (Importante + Muy importante) y 'No es importante' (Nada importante + Algo Importante)
```{r,results='asis'}
getah.or1 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi2_ap",ref),collapse="+"))), basereg)
getah.or2 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("sj_indirect_noln",ref),collapse="+"))), basereg)
getah.or3 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("sj_direct_factor",ref),collapse="+"))), basereg)
getah.or4 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor",ref),collapse="+"))), basereg)
getah.or5 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor",con,ref),collapse="+"))), basereg)
getah.or6 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi2_ap*sj_indirect_noln",ref),collapse="+"))), basereg)
getah.or7 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi2_ap*sj_direct_factor",ref),collapse="+"))), basereg)
getah.or8 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi2_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi2_ap*sj_direct_factor","univ_esc",ref),collapse="+"))), basereg)
...
knitreg(list(getah.or1,getah.or2,getah.or3,getah.or4,getah.or5,getah.or6,getah.or7,getah.or8),
        ...
        #             "Sentido justicia (directo)"=7:8),
        custom.coef.names=coef_names,
        custom.note="*** p < 0.001; ** p < 0.01; * p < 0.05; ¹'Es importante' (Importante + Muy importante) y 'No es importante' (Nada importante + Algo Importante)"
        )
```

* Dummy de apoderado: 'Es importante' (Muy importante) y 'No es importante' (Nada importante + Algo Importante +Importante)

```{r,results='asis'}
getah.or1 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi3_ap",ref),collapse="+"))), basereg)
getah.or2 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("sj_indirect_noln",ref),collapse="+"))), basereg)
getah.or3 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("sj_direct_factor",ref),collapse="+"))), basereg)
getah.or4 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor",ref),collapse="+"))), basereg)
getah.or5 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor",con,ref),collapse="+"))), basereg)
getah.or6 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi3_ap*sj_indirect_noln",ref),collapse="+"))), basereg)
getah.or7 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi3_ap*sj_direct_factor",ref),collapse="+"))), basereg)
getah.or8 <- clmm(formula(paste("perc_trabajo_duro_factor_est~",paste(c("perc_tduro_bi3_ap","sj_indirect_noln","sj_direct_factor", con, "perc_tduro_bi3_ap*sj_direct_factor","univ_esc",ref),collapse="+"))), basereg)
...
knitreg(list(getah.or1,getah.or2,getah.or3,getah.or4,getah.or5,getah.or6,getah.or7,getah.or8),
        ...
        #             "Sentido justicia (directo)"=7:8),
        custom.coef.names=coef_names,
        custom.note="*** p < 0.001; ** p < 0.01; * p < 0.05; ¹'Es importante' (Muy importante) y 'No es importante' (Nada importante + Algo Importante+Importante)"        
        )
```


#### Recompensa escuela y trato profesor
