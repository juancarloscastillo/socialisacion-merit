...
- High school students (2nd) and parents (n = 541) nested in schools (n = 60)
...
.center[
![:scale 100%](images/perc-merit.jpg)
]
...
.pull-left[
.bold[Obtained:] _What was your last year average grade? If you don't remember exactly, please give an approximate grade._ (M= 5.8)

.bold[Deserved:] _And, what grade average do you think you deserved?_ (M=6.0)
...
_Taking into account the time I dedicate to my studies, the grades I get are:_
...
.center[![:scale 85%](images/intergetahead1.png)]
]
...
- Family socialisation: parents positively influence student's perceived meritocracy 
...
[github.com/juancarloscastillo/socialisacion-merit](https://github.com/juancarloscastillo/socialisacion-merit)
